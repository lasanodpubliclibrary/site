        ...
        <Drawer.Root shouldScaleBackground>
          ...
          <Drawer.Portal>
            ...
            <Drawer.Content className="bg-card shadow-sm border  flex flex-col rounded-t-[10px] h-full mt-24 max-h-[90%] fixed bottom-0 left-0 right-0 px-7">
              <div className="p-4 relative bg-card rounded-t-[10px] flex-1 overflow-auto scrollbar-none">
                <div className="mx-auto sticky top-0 w-12 h-1.5 flex-shrink-0 rounded-full mb-8 bg-slate-300 dark:bg-slate-600" />
